...
import { idlFactory } from './kybra_hello_world.did.js';
export { idlFactory } from './kybra_hello_world.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_KYBRA_HELLO_WORLD;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./kybra_hello_world.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the kybra_hello_world canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./kybra_hello_world.did.js")._SERVICE>}
 */
